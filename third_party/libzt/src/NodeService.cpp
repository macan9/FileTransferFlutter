    ...
    int len)
{
    ...
    switch (type) {
        case ZT_STATE_OBJECT_IDENTITY_PUBLIC:
            ...
            if (data != nullptr && len > 0) {
                memcpy(_publicIdStr, data, static_cast<size_t>(len));
            }
        ...
        case ZT_STATE_OBJECT_IDENTITY_SECRET:
            ...
            if (data != nullptr && len > 0) {
                memcpy(_secretIdStr, data, static_cast<size_t>(len));
            }
            if (_homePath.length() > 0 && _allowIdentityCaching) {
        ...
        case ZT_STATE_OBJECT_PLANET:
            ...
            if (data != nullptr && len > 0) {
                memcpy(_rootsData, data, static_cast<size_t>(len));
            }
    ...
    if (len >= 0 && data != nullptr) {
        ...
        if (f) {
            if (fwrite(data, static_cast<size_t>(len), 1, f) != 1)
                fprintf(
                    stderr,
